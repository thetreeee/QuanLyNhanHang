...
public class SoDoBanPanel extends JPanel {
    ...
    private final Color COLOR_PINK = new Color(255, 182, 193);   // Hồng khi chọn tầng
    private final Color TEXT_DARK = new Color(44, 56, 74);       // Màu chữ tiêu đề
    ...
    private void initUI() {
        // --- ĐỒNG BỘ LỀ VÀ KHOẢNG CÁCH Y HỆT KHUYENMAIPANEL ---
        ...
        JLabel lblTitle = new JLabel("QUẢN LÝ SƠ ĐỒ BÀN");
        ...
        card.addMouseListener(new MouseAdapter() {
            @Override public void mouseClicked(MouseEvent e) {
                if (e.getClickCount() == 2) {
                    DialogThemSuaBan dialog = new DialogThemSuaBan(null, ban);
                    dialog.setVisible(true);
                    if (dialog.isThanhCong()) loadData(txtSearch.getText());
                }
            }
